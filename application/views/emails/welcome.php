...
<table width="650" align="center" style="font-size: 14px;" cellpadding="0" cellspacing="0">
    ...
    <tr id="header">
        ...
        <td height="102" background="https://www.dropbox.com/static/images/emails/header_bg.gif" bgcolor="#e6f1fb" align="center">
            <table width="95%"><tr>
                    <td align="left">
                        <img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQOhRNt-e4kAbx1isxkLeYweUg61gHkDkIeKtK3LMLfld_iQ3r3jg"/>
                    </td>
                </tr></table>
        </td>
    ...
    Dear <? echo $name ?>,<br/><br/>
Congratulations on creating your account on Marketingbazar and your Marketingbazar account is ready to go!<br/><br/>
Before you start your adventure, please make sure to do the following things<br/><br/>
<div style="padding-left: 20px;">
    - Go to McDonald's and ask for directions to Burger King<br/>
    - Walk up to a small child that resembles you, and tell him that you are him from the future<br/>
    - Run through a police station and yell "I finally escaped from prison!"
</div>
<br/>
Again, welcome to Marketingbazar!<br/><br/>
- The Marketingbazar Team<br/><br/>
If you need a refresher, <a href="https://www.marketingbazar.com">check out our tour</a></font>
</td>
</tr>
</table>
</td>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="font-size: 11px; color: #909090; padding-left: 45px;">
                    If you prefer not to receive these tips from Marketingbazar, please click <a href="https://www.marketingbazar.com">here</a>
                </td>
                <td style="text-align: right; width: 120px;">
                    <span style="font-size: 12px; color: #888;">&copy;&nbsp;2013&nbsp;Marketingbazar</span>
                </td>
            </tr>
        </table>
    </td>
